  ...
  return (
    <div className=" py-10 px-[10px] sm:px-[80px]">
      ...
      <div className="grid grid-cols-1 gap-y-4 sm:grid-cols-4 mt-12 gap-x-8">
        ...
        <div className="col-span-3 h-[500px] bg-[#F6F6F6] p-8 rounded-lg">
          <div className="flex flex-col h-full md:flex-row gap-3 items-center md:items-start justify-center">
            <div className="border flex-1 h-full border-[#999] py-4 px-4 flex flex-col">
              <h3 className="text-center text-black text-[24px]">Assets-1</h3>
              <h5 className="text-[20px] mt-2">What can be compared?</h5>
              <span className="text-[15px] ">
                - General price change of the last day/week/month/year/all time
              </span>
              <span className="text-[15px]">
                - Algorithm performance (realizable profit)
              </span>
              <span className="text-[15px]">
                {" "}
                - Algorithm performance (hit performance)
              </span>
            </div>
            <div className="border flex-1 w-full h-full border-[#999] py-4 px-4 flex flex-col">
              <h3 className="text-center text-black text-[24px]">Assets-1</h3>
            </div>
            <div className="border flex-1 h-full w-full border-[#999] py-4 px-4 flex flex-col">
              <h3 className="text-center text-black text-[24px]">Assets-1</h3>
            </div>
          </div>
        </div>
